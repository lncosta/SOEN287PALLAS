...
<html>
  ...
  <main>
		  <div align="center">
                ...
                <br/>
                <!-- Display the first entertainementvideo  -->
        <iframe width="1180" height="664" src="https://www.youtube.com/embed/5G8vX9OVbK8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
        </iframe>
            
                <!-- Display the second entertainementvideo  -->
        <iframe width="1180" height="664" src="https://www.youtube.com/embed/804uNConaDg" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
        </iframe>
                <br>
        ...
        <iframe id="_ytid_62635" width="644" height="362" src="https://www.youtube.com/embed/KvBlZENkF5E">https://www.youtube.com/watch?enablejsapi=1&autoplay=0&cc_load_policy=0&iv_load_policy=1&loop=0&modestbranding=0&rel=1&showinfo=1&fs=1&playsinline=0&controls=2&autohide=2&theme=dark&color=red&" class="__youtube_prefs__" title="YouTube player"  allow="autoplay; encrypted-media" allowfullscreen data-no-lazy="1" data-skipgform_ajax_framebjll="">
        </iframe>
                <br/>
                <br/>
        ...
        <div id="myEvaluation">
            ...
            <span class="fa fa-star checked" id="rate1"></span>
            <span class="fa fa-star checked" id="rate2"></span>
            <span class="fa fa-star checked" id="rate3"></span>
            <span class="fa fa-star checked" id="rate4"></span>
            <span class="fa fa-star unchecked" id="rate5"></span>
