    ...
    <main>
        ...
        <div class="box">
            ...
            <details>
                ...
                <p class="text">Pallas Entertainment is a event entertainment and performance company. We offer services from children's party entertainment to festival-level circus acts. We are a Montreal-based entertainment company that provides acts and performances to bring life to events big and small.</p>
            </details>
            <details>
                <summary>Why the name Pallas?</summary>
                <p class="text">The name Pallas is the given epithet of Ancient Greek goddess Athena, associated with wisdom and handicraft. We thought those were important elements to bring to the entertainment industry, and look to the godess Athena as a source of motivation.
                </p>
            </details>

            <details>
                <summary>Who invented Pallas?</summary>
                <p class="text">A group of Concordia Univeristy students had the idea for Pallas Entertainment for a course project. Then, a few of our more artistic-inclined members decided to join in. We started as just a group of friends trying to build upon our hobbies, and now we are a full-fledged, world-recognized company. What a ride!.
                </p>
            </details>
        ...
        <div class="box">
            ...
            <details>
                ...
                <p class="text"> Though an account is not necessary to browse the website or ask for a quote estimation through email, having one is highly recommended.
            ...
            <details>
                ...
                <p class="text">In the case of unauthorized account use, please contact the customer services to retrieve it. If the payment was made, please contact the bank for further information. We will never share our customer's information to
            ...
            <details>
                ...
                <p class="text">If you decide to no longer use our website, you can write an us an email to delete your account. Once the
            ...
            <details>
                ...
                <p class="text"> The only time your information will be visible to other users is if you decide to publish a review. In that case, your first name and review will be posted to our review page. If you do not wish for your name to be published, you can opt to review our services through Yelp instead, or just send us an email with your thoughts.
                </p>
            </details>
        </div>
        ...
        <div class="box">
            ...
            <details>
                ...
                <p class="text">You can either go to the ticket sales page and select which you would like to watch. The payment will go through your choice of
            ...
            <details>
                ...
                <p class="text">If you are a booker, just visit the booked performances section in your user page and click the "Add tickets for sale" button.
            ...
            <details>
                ...
                <p class="text">Pallas recommends digital tickets, but people who want to keep the physical (paper) ticket as a sourvenir can chose to print the ticket PDF. You can view your purchased tickets on your user page.
                </p>
            </details>

            <details>
                <summary>Can I sell my ticket to someone else?</summary>
                <p class="text">You can sell ticket to someone else if you decide to no longer attend the event. However, ticket re-sale is limited to a single ticket per user, and it must be at the original ticket price or lower.
        ...
        <div class="box">
            ...
            <details>
                ...
                <p class="text">Pallas will accept MasterCard, Visa, and Paypal. You can reach out to us through email to discuss any other payment methods.</p>
            </details>
            <details>
                <summary>What if I regret the purchase of a ticket?</summary>
                <p class="text">Up to 48 hours before the performance begins, the ticket is refundable. Just click my order and click "cancel order" button, and the refund will
            ...
            <details>
                ...
                <p class="text">The refund for the ticket will depend on the bank. Usually it takes 3~5 bussiness days. If you did not receive
            ...
            <details>
                ...
                <p class="text">There are many reason that the payment can be rejected. If the payment method is not wrong (such as the card information, the credit limit),
